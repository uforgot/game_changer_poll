                ...
                pollDatas : [
                    {
                        ...
                        polls:[
                            ...
                            '내가 하고 싶은 것고 내가 해왔던 것과 차이가 나지 않는다',
                    ...
                    },
                    {
                        ...
                        polls:[
                            ...
                            '우리 가족은 가족관계가 평등한 정도에 만족 한다',
                            '우리 가족은 가족내의 변화(이사, 입학, 이직) 등에 대한 가족의 적응력 정도에 만족한다',
                    ...
                    },
                    {
                        ...
                        polls:[
                            ...
                            '나는 지난 5년 간 경제적인 어려움 때문에 고민한적이 없다',
                            '나는 본인 또는 자녀의 교육이나 취직 문제로 고민 하지 않는다',
                            '나 또는 우리 가족은 은퇴 후 경제적으로 걱정없이 살 준비를 하고 있다'
                        ]
                    }
                ]
            };
